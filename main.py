    ...
    with st.container():
        ...
        with col2:
            ...
            fig_c1 = go.Figure(go.Indicator(
                ...
                number={'suffix': "", "font": {"size": 40, 'color': "#C81F6D", 'family': "Georgia"}},
        ...
        with col4:
            ...
            fig_c2 = go.Figure(go.Indicator(
                ...
                number={'suffix': "", "font": {"size": 40, 'color': "#C81F6D", 'family': "Georgia"}, 'valueformat': ',f'},
        ...
        with col6:
            ...
            fig_c3 = go.Figure(go.Indicator(
                ...
                number={'suffix': "º", "font": {"size": 40, 'color': "#C81F6D", 'family': "Georgia"}},
